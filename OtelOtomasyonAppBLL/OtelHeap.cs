...
{
   public class OtelHeap
    {
        private OtelHeapDugumu[] heapArray;
        private int maxSize;
        private int currentSize;
        public OtelHeap(int maxHeapSize)
        {
            maxSize = maxHeapSize;
            heapArray = new OtelHeapDugumu[maxSize];
            currentSize = 0;
}
        public bool IsEmpty()
        {
        ...
        public bool Insert(int value)
        {
            if (currentSize == maxSize)
                return false;
            OtelHeapDugumu newHeapDugumu = new OtelHeapDugumu(value);
        ...
        public void MoveToUp(int index)
        {
            ...
            OtelHeapDugumu bottom = heapArray[index];
        ...
        public OtelHeapDugumu RemoveMax() // Remove maximum value HeapDugumu
        {
            OtelHeapDugumu root = heapArray[0];
        ...
        {
            int largerChild;
            OtelHeapDugumu top = heapArray[index];
